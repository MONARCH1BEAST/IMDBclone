...
const MovieCard = ({ id, title, rating, image, year, genre }) => {
  const prefetchDetails = usePrefetchMovieDetails(id);

  return (
    <div
      className="bg-zinc-900/50 rounded-lg overflow-hidden movie-card-hover backdrop-blur-sm"
      onMouseEnter={prefetchDetails}
      onMouseLeave={prefetchDetails.cancel}
      onFocus={prefetchDetails}
      onBlur={prefetchDetails.cancel}
    >
